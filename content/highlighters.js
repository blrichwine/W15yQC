            ...
            for(i=0; i<aDocumentsList.length; i++) {
                ...
                if(doc != null) {
                    ...
                    for(j=0;j<aHeadingsList.length;j++) {
                        ...
                        span1=aHeadingsList[j].doc.createElement('span');
                        span1.setAttribute('style','position:static;clear:both');
                        span1.className='w15yqcInsert';
                        insert=aHeadingsList[j].doc.createElement('span');
                        insert.className='w15yqcHxInsert';
                        //insert.setAttribute('title',aHeadingsList[j].text);
                        insert.appendChild(aHeadingsList[j].doc.createTextNode('H'+aHeadingsList[j].level.toString()));
        ...
        if(aDocumentsList != null && aDocumentsList.length>0) {
            for(var i=0; i<aDocumentsList.length; i++) {
                ...
                if(doc != null) {
                    ...
                    infoElements = doc.getElementsByClassName('w15yqcInsert');
