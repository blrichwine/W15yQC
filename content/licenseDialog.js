 ...
 * File:        licenseDialog.js
 * Description: Handles displaying the license agreement dialog
 ...
 * Returns:
 */
blr.W15yQC.LicenseDialog = {

  init: function (dialog) {
    var if1 = document.getElementById('license-text');
    if1.contentDocument.body.style.margin = '0';
    if1.contentDocument.body.style.padding = '3px';
    this.showBriefLicense();
  },
  ...
  toggleLicense: function () {
    if (document.getElementById('button-showFullLicense').getAttribute('label') == 'Show brief license') {
      this.showBriefLicense();
    } else {
      this.showFullLicense();
    }
  },
  ...
  showBriefLicense: function () {
    ...
    document.getElementById('button-showFullLicense').setAttribute('label', 'Show full license');
  },

  showFullLicense: function () {
    var if1 = document.getElementById('license-text');
    if1.contentDocument.body.innerHTML = '<p>Apache License<br></br>Version 2.0, January 2004<br></br>' +
