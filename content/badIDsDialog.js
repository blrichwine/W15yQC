...
blr.W15yQC.badIDsDialog = {
    ...
    init: function(dialog) {
        ...
        if(dialog!= null && dialog.arguments != null && dialog.arguments.length>1) { blr.W15yQC.badIDsDialog.FirebugO=dialog.arguments[1]; }
        ...
        if(blr.W15yQC.badIDsDialog.FirebugO == null || !blr.W15yQC.badIDsDialog.FirebugO.Inspector ) { document.getElementById('button-showInFirebug').hidden=true; }
    },
