function videoModel(videoId){
	...
	self.link=ko.computed(function(){
		var link= (this.channel()==='HLN')?"http://www.cnn.com/video/?/video/cvptve/cvpstream2":"http://www.cnn.com/video/?/video/cvptve/cvpstream1";
		try{
		...
		try{
			var cb=function(){
				...
				if(self.isTVE()){
					...
					var url=self.nowPlayingURL()+'?callback='+callbackName,id=createId(url);
